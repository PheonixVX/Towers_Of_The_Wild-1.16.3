...
import io.github.ender.towersofthewild.structures.pieces.IceTowerPools;
...
public class IceTowerStructure extends AbstractTowerStructure {
	public IceTowerStructure(Codec<StructurePoolFeatureConfig> codec) {
		super(codec);
	}
	...
	public static class Start extends MarginedStructureStart<StructurePoolFeatureConfig> {
		...
		public void init(DynamicRegistryManager registryManager, ChunkGenerator generator, StructureManager manager, int p_230364_4_, int p_230364_5_, Biome p_230364_6_, StructurePoolFeatureConfig featureConfig) {
			...
			if (!IceTowerPools.registered) {
				IceTowerPools.init(registryManager);
			}
